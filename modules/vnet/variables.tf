variable "name" {
  type        = string
  description = "Name use across all resources related to this VNET"
}
...
variable "instance_tenancy" {
  type        = string
  description = "Tenancy for instances launched into the VNET."
  default     = "default"
}

variable "ipv6_enabled" {
  type        = bool
  description = "Whether or not to enable IPv6 support in the VNET."
  default     = true
}
